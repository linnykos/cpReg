...
zz1 <- cpReg::high_dim_buhlmann_estimate(dat$X, dat$y, lambda = lambda, gamma = res$min_gamma,
                                  verbose = F, max_candidates = NA, delta = delta)
zz2 <- cpReg::high_dim_buhlmann_estimate(dat$X, dat$y, lambda = lambda, gamma = res$max_gamma,
                                         verbose = F, max_candidates = NA, delta = delta)
